...
class courseblog_edit_form extends moodleform {
...
echo "courseid = $courseid</br>";
        ...
        $mform->addElement('hidden', 'publishstate', 0);
        $mform->setType('publishstate', PARAM_INT);
        ...
        $mform->addElement('hidden', 'new');
        $mform->setType('new', PARAM_INT);
        $mform->setDefault('new', 1);

        $mform->addElement('hidden', 'd');
        $mform->setType('d', PARAM_INT);
        $mform->setDefault('d', 0);
